...
***
From `2.1.21` must be updated `exch_srv_cfg.toml`. See [Use templates for reference.](https://github.com/DogsTailFarmer/exchanges-wrapper/blob/master/exchanges_wrapper/exch_srv_cfg.toml.template)
***
